...
try {
  ...
  const message = [
    ...
    '',
    'Skill invocation patterns (use the one matching the host you are):',
    '  Claude Code: /skill-name  (e.g. /inventorlab-setup)',
    '  Codex:       $inventorlab:skill-name  (e.g. $inventorlab:inventorlab-setup)',
    '               (or describe what you want in natural language)',
    '',
    '- Invoke the inventorlab-setup skill to configure this project. It adds',
    '  IP-tracking instructions to AGENTS.md (with a CLAUDE.md import for',
    '  Claude Code), creates the working directories, and enables Invention',
    '  Radar (background novelty detection as they code).',
    '',
    ...
    '',
    'Surface skill names using the invocation pattern matching the current',
    'host. Keep it concise and friendly. Surface this once; do not repeat it.'
  ].join('\n');
